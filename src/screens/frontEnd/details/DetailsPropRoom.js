    ...
    <>
      ...
      <div className="property_room_container">
        ...
        <div className="price_checkout_in_date">
          <span>{`${state.propertyRooms?.prezzo}/${t('fe.components.rooms.priceForNumberOfNights', { number: 1 })}`}</span>
        </div>
          ...
          <p>numero di posti letto disponibili</p>
          {
            state?.propertyRooms?.numPostiLetto < 5 ?
              ...
              <>
                ...
                <span>
                  {state?.propertyRooms?.numPostiLetto} {t('fe.components.rooms.people')}
                </span>
              </>
